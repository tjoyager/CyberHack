...
export default function DashboardOverview() {
  ...
  const summaryCards = [
    { title: "Pending QC", value: dashboardMetrics.pending_qc.toString(), icon: Clock, color: "text-amber-600", bgColor: "bg-amber-50", path: "/dashboard/qc" },
    { title: "Approved / Ready", value: dashboardMetrics.approved.toString(), icon: CheckCircle, color: "text-green-600", bgColor: "bg-green-50", path: "/dashboard/ppic" },
    { title: "In Production", value: dashboardMetrics.in_production.toString(), icon: Package, color: "text-blue-600", bgColor: "bg-blue-50", path: "/dashboard/ppic" },
    { title: "Rejected Lots", value: dashboardMetrics.rejected.toString(), icon: XCircle, color: "text-red-600", bgColor: "bg-red-50", path: "/dashboard/qc" },
  ];
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="bg-white rounded-2xl border border-border shadow-sm overflow-hidden">
        <div className="p-6 border-b border-border bg-slate-50/50 flex items-center justify-between">
          ...
          <button onClick={() => navigate("/dashboard/intake")} className="text-xs font-bold text-primary hover:underline uppercase tracking-widest">
            View All
          </button>
        </div>
